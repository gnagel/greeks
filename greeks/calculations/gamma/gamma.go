...
func Gamma(opts *GammaOpts) float64 {
	if math.IsNaN(opts.IV) || math.IsNaN(opts.ND1) {
		return math.NaN()
	}

	return opts.ND1 * opts.RateVsExpires / (opts.StockPrice * opts.IV * opts.OptionExpiresYearPctSqrt)
}
